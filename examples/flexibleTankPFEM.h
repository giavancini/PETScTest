...
Point *p4 = fluid_geo->addPoint({0.1 , 0.1  , 0.0});
Point *p5 = fluid_geo->addPoint({0.0 , 0.1  , 0.0});
...
Line *l4 = fluid_geo->addLine({p2, p4});
Line *l5 = fluid_geo->addLine({p3, p5});
...
fluid_geo->transfiniteLine({l4}, 0.02 / h + 1);
fluid_geo->transfiniteLine({l5}, 0.02 / h + 1);
...
Point *p6 =  solid_geo->addPoint({0.1   , 0.0  , 0.0});
Point *p7 =  solid_geo->addPoint({0.112 , 0.0  , 0.0});
Point *p8 =  solid_geo->addPoint({0.112 , 0.1  , 0.0});
Point *p9 =  solid_geo->addPoint({0.1   , 0.1  , 0.0});
Point *p10 = solid_geo->addPoint({0.1   , 0.08 , 0.0});
...
Line *l10 = solid_geo->addLine({p10, p6});
Surface *s1 = solid_geo->addPlaneSurface({l6, l7, l8, l9, l10});
solid_geo->transfiniteLine({l6}, 0.012 / h + 1);
solid_geo->transfiniteLine({l7}, 0.1 / h + 1);
solid_geo->transfiniteLine({l8}, 0.012 / h + 1);
solid_geo->transfiniteLine({l9}, 0.02 / h + 1);
solid_geo->transfiniteLine({l10}, 0.08 / h + 1);
solid_geo->transfiniteSurface({s1}, "Left", {p6, p7, p8, p9});
solid_geo->addDirichletBoundaryCondition({l6}, ALL, 0.0);
