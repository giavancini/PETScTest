...
Point *p2  = fluid_geo->addPoint({L       , 2.0*L , 0.0});
Point *p3  = fluid_geo->addPoint({0.0     , 2.0*L , 0.0});
Point *p4  = fluid_geo->addPoint({0.0     , 4.0*L , 0.0});
Point *p5  = fluid_geo->addPoint({2.0*L   , 0.0   , 0.0});
Point *p6  = fluid_geo->addPoint({2.0*L   , H     , 0.0});
Point *p7  = fluid_geo->addPoint({2.0*L+D , H     , 0.0});
Point *p8  = fluid_geo->addPoint({2.0*L+D , 0.0   , 0.0});
Point *p9  = fluid_geo->addPoint({4.0*L+D , 0.0   , 0.0});
Point *p10 = fluid_geo->addPoint({4.0*L+D , 4.0*L , 0.0});
...
fluid_geo->transfiniteLine({l6}, H / h + 2);
fluid_geo->transfiniteLine({l7}, D / h + 1);
fluid_geo->transfiniteLine({l8}, H / h + 2);
fluid_geo->transfiniteLine({l9}, 2*L / h + 1);
fluid_geo->transfiniteLine({l10}, 4*L / h + 1);
...
Point *p11  = solid_geo->addPoint({2.0*L   , 0.0   , 0.0});
Point *p12  = solid_geo->addPoint({2.0*L   , H     , 0.0});
Point *p13  = solid_geo->addPoint({2.0*L+D , H     , 0.0});
Point *p14  = solid_geo->addPoint({2.0*L+D , 0.0   , 0.0});
...
solid_geo->transfiniteLine({l13}, H / h + 2);
solid_geo->transfiniteLine({l14}, D / h + 1);
solid_geo->transfiniteLine({l15}, H / h + 2);
