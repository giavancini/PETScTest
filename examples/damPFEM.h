...
dam_geo->transfiniteLine({l1}, 2.0*L/h+1);
dam_geo->transfiniteLine({l2}, L/h+1);
dam_geo->transfiniteLine({l3}, 2.0*L/h+1);
dam_geo->transfiniteLine({l4}, 3.0*L/h+1);
dam_geo->transfiniteLine({l5}, 4.0*L/h+1);
dam_geo->transfiniteLine({l6}, 2.0*L/h+1);
